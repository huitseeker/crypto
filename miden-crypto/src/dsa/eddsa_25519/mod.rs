...
impl crate::ecdh::KeyAgreementScheme for PublicKey {
    type EphemeralSecretKey = crate::ecdh::x25519::EphemeralSecretKey;
    type EphemeralPublicKey = crate::ecdh::x25519::EphemeralPublicKey;
    type SecretKey = SecretKey;
    type SharedSecret = crate::ecdh::x25519::SharedSecret;

    fn generate_ephemeral_keypair<R: rand::CryptoRng + rand::RngCore>(
        &self,
        rng: &mut R,
    ) -> (Self::EphemeralSecretKey, Self::EphemeralPublicKey) {
        // Generate X25519 ephemeral keypair for use with this Ed25519 public key
        let sk = crate::ecdh::x25519::EphemeralSecretKey::with_rng(rng);
    ...
    fn exchange_ephemeral_static(
        ...
        // Perform DH between X25519 ephemeral secret and this Ed25519 public key
        // The EphemeralSecretKey.diffie_hellman method expects an Ed25519 PublicKey
        Ok(ephemeral_sk.diffie_hellman(self))
    }
    ...
    fn dummy_public_key_for_secret_key(secret_key: &Self::SecretKey) -> Self {
        // For Ed25519, we can derive the public key directly from the secret key
